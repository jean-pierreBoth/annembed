...
impl DiffusionMaps {
            ...
            + Into<f64>,
    {
        ...
        // get NodeParams.
        let (nodeparams, mut q_density) = self.compute_dmap_nodeparams::<F>(kgraph, 8);
            ...
            + Into<f64>,
    {
        ...
        let (_, q_density) = self.scales_to_kernel(kgraph, nbng, &local_scales, &remap_weight);
